...
\emph{functionally-inconsistent}.

{\color{blue} To see this \emph{non functional-consistency} explicitly in} our model and to see its
...
construction which is non-contextual (and \emph{non
functionally-consistent}).


We end with making two short remarks.} First, we illustrate
how non \emph{functional-consistency} gives rise to situations which
