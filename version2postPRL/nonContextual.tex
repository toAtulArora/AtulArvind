...
\title{Revisiting the notion of Contextuality in Quantum Mechanics}
...
% Mechanics}}
\shorttitle{ Revisiting Contextuality in QM} 
...
thereby capturing the same idea { without undue
...
% {  Sentence below has been edited}
...
\emph{functionally-consistent}) which is in stark contrast with our
...
non \emph{functional-consistency} as an alternative to
