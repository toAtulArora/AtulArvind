...
$\hat{C}_{3}$. {\color{blue} Atul: Kishor could you please verify the calculation.} To simplify calculations, we note
...
&&\!\left|00\right\rangle \left\langle 00\right|+
\left|10\right\rangle \left\langle 10\right|-
\left[\left|01\right\rangle \left\langle 01\right|+
\left|11\right\rangle \left\langle 11\right|\right], \\
&&\hat{C}=\!f(\{\hat{B}_{i}\}) \\
...
11\right|. 
\end{eqnarray*}
We introduced $\hat{C}$ as an example of a \emph{refinement}, i.e. an observable 
whose measurement can reveal the values of other compatible observables
which in this case are $\hat B_1$ and $\hat B_2$. To see this, note that $\hat C$
...
more basic. {\color{blue} Atul: The referee wants a physical meaning of this. I am not sure how to respond.}

\section{Conclusion}
 {\color{blue} Atul: The refere wants this section to be made more particular; feel free to improve upon/add to the following.}
...
in the area of quantum computation. In particular, it has been shown that an established measure of contextuality can be related directly to a measure of the quantum advantage obtained in the measurement based model of quantum computing [Kishor cite]. A dynamical study of contextuality/non functional-consistency is expected to open up similar connections and deepen our understanding of the strange computational power of quantum mechanics.
