...
{\color{blue} While there have been generalisations, in this letter, we restrict ourselves to the standard notion of non-contextuality as used by KS~\cite{KochenSpecker}.} 
...
$\hat{C}$. {\color{blue} In our treatment, instead of imposing functional consistency, we demand its aforesaid weaker variant. It captures the same idea, however, only when it has a precise meaning according to QM.} \sout{To capture this property precisely we define} {\color{blue} To this end we define}
